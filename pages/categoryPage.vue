  ...
  <div class="category">
    ...
    <div class="category__header">
      <div class="category__header-bottom">
        <div class="container">
          <!-- title -->
          <h3 class="category__title">Aravachalar</h3>
    ...
    <div class="category__main">
      <div class="container">
          ...
          <div class="category-filter__range">
            ...
            <ul class="category-filter__range-price-wrapper">
              <li class="category-filter__range-price">
                Dan <span id="slider-range-value1">1 550 000</span>
              </li>

              <li class="category-filter__range-price">
                Gacha <span id="slider-range-value2">3 550 000</span>
              </li>
            </ul>
          ...
          <div class="accordion">
            ...
            >
              ...
              <div class="accordion-content">
                <div class="relative flex items-center" v-for="i in 4" :key="i">
        ...
        <div class="category__main-right">
          ...
          >
            <category-card v-for="i in 12" :key="i" />
          </div>
        </div>
      </div>
    </div>
